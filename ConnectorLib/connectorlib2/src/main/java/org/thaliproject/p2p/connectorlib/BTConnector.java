 ...
 */
public class BTConnector implements BluetoothBase.BluetoothStatusChanged, BTConnector_Discovery.DiscoveryCallback, BTConnector_BtConnection.ListenerCallback {
    ...
    private void startServices() {
        ...
        mBTConnector_Discovery = new BTConnector_Discovery(this.context, this,this.ConSettings.SERVICE_TYPE,this.mInstanceString);
