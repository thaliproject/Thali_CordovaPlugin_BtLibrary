...
public class BTConnector_Discovery implements AdvertiserCallback {
    ...
    public BTConnector_Discovery(Context Context, DiscoveryCallback Callback, String ServiceType, String instanceLine){
        ...
        this.mFirstService = new BluetoothGattService(UUID.fromString(BTConnector.SERVICE_UUID_1),BluetoothGattService.SERVICE_TYPE_PRIMARY);


        BluetoothGattCharacteristic firstServiceChar = new BluetoothGattCharacteristic(UUID.fromString(BTConnector.CharacteristicsUID1),BluetoothGattCharacteristic.PROPERTY_READ,BluetoothGattCharacteristic.PERMISSION_READ );
        firstServiceChar.setValue(instanceLine.getBytes());

        BluetoothGattCharacteristic secondServiceChar = new BluetoothGattCharacteristic(UUID.fromString(BTConnector.CharacteristicsUID2),BluetoothGattCharacteristic.PROPERTY_WRITE,BluetoothGattCharacteristic.PERMISSION_WRITE );
